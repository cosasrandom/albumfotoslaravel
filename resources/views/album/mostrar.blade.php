                    ...
                    @if ($albumes->isEmpty())
                        ...
                        <div class="text-center py-12">
                            <div class="max-w-md mx-auto">
                                ...
                                <!-- Asume que tienes una ruta 'album.create' para crear álbumes -->
                                ...
                                <div class="bg-white border border-pink-100 rounded-xl shadow-md overflow-hidden transition-all duration-300 hover:shadow-xl hover:border-pink-200">
                                    ...
                                    <div class="p-4">
                                        ...
                                        <div class="mt-4">
                                            ...
                                            <div class="grid grid-cols-2 gap-2">
                                                ...
                                                <div class="relative overflow-hidden rounded-lg aspect-square border-2 border-white shadow">
                                                    ...
                                                    <img src="{{ asset('storage/' . $foto->foto_ruta) }}" alt="{{ $foto->nombre }}" class="w-full h-full object-cover transform transition duration-500 hover:scale-110">
                                        ...
                                        <div class="mt-4 flex flex-wrap gap-2">
                                            <a href="{{ route('foto.index', ['album_id' => $album->id]) }}" class="flex-1 min-w-[120px] inline-flex items-center justify-center px-3 py-2 bg-gradient-to-r from-emerald-500 to-teal-600 border border-transparent rounded-full font-semibold text-xs text-white uppercase tracking-widest hover:opacity-90 transition-all">
                                                <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <a href="{{ route('album.getActualizar', $album->id) }}" class="inline-flex items-center justify-center px-3 py-2 bg-gradient-to-r from-lime-400 to-green-500 border border-transparent rounded-full font-semibold text-xs text-white uppercase tracking-widest hover:opacity-90 transition-all">
                                                <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            {{-- <form action="{{ route('album.eliminar', $album->id) }}" method="POST" onsubmit="return confirm('¿Está seguro que desea eliminar este álbum y todas sus fotos? Esta acción no se puede deshacer.');" class="flex-1 min-w-[120px]">
                                                @csrf
                                                @method('DELETE')
